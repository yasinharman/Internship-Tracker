 ...
 *
 * Tighter than the reference's card on purpose. Its four sit across the top
 * of the page, where they are the subject; these are stacked down the sidebar
 * beside the posting list, which is.
 */
